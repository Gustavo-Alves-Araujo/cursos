...
import { Crown, Lock, Eye, EyeOff, CheckCircle, KeyRound } from 'lucide-react';
...
function RedefinirSenhaContent() {
  ...
  useEffect(() => {
    ...
    // A validação real será feita no momento do submit
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Primeiro, tentar obter a sessão da URL se não estiver logado
